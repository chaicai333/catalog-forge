...
## CatalogForge setup (local)

- Start services: `docker compose up -d`
- Copy env: `cp .env.example .env`
- Install + migrate: `npm install && npx prisma migrate dev --name init`
- Run app: `npm run dev`
- Run worker (new terminal): `npm run dev:worker`

More details: `docs/local-dev.md`
